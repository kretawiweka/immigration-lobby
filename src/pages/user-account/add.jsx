          ...
          <Card>
            ...
            >
              ...
              <Row>
                <Col span={5}></Col>
                <Col span={4}>
                  Username<strong style={{ color: 'red' }}>*</strong>
                </Col>
                <Col span={10}>
                  <Form.Item>
              ...
              <Row>
                <Col span={5}></Col>
                <Col span={4}>
                  Ulangi Password<strong style={{ color: 'red' }}>*</strong>
                </Col>
                <Col span={10}>
                  <Form.Item>
                    <Space direction="vertical" style={{ width: '100%' }}>
              ...
              <Row>
                <Col span={5}></Col>
                <Col span={4}>
                  Hak Akses<strong style={{ color: 'red' }}>*</strong>
                </Col>
                <Col span={10}>
                  <Form.Item>
                    <Select
              ...
              <Row>
                <Col span={5}></Col>
                <Col span={4}>
                  Kantor Imigrasi<strong style={{ color: 'red' }}>*</strong>
                </Col>
                <Col span={10}>
                  <Form.Item>
                    <Select
              ...
              <Row>
                <Col span={5}></Col>
                <Col span={4}>
                  Pangkat<strong style={{ color: 'red' }}>*</strong>
                </Col>
                <Col span={3}>
                  <Form.Item>
                    <Select
                ...
                <Col span={2}></Col>
                <Col span={2}>
                  Golongan<strong style={{ color: 'red' }}>*</strong>
                </Col>
                <Col span={3}>
                  <Form.Item>
                    <Select
