      ...
      <Layout>
        ...
        <Content>
          <CardContent>
            <Link to="/laporan/rekam-counter" style={{ marginLeft: '550px' }}>
              <Card backgroundColor="#e8e8e8" width="200px" style={{ height: '240px'}}>
                <Row>
                  ...
                  <Row>
                    <Col span={24}>
                      <CardTitle>Rekam<br></br>Counter</CardTitle>
                    </Col>
                  </Row>
                  </Col>
                </Row>
            ...
            <Link to="/laporan/informasi-sering-ditanyakan" style={{ marginLeft: '50px' }}>
              <Card backgroundColor="#e8e8e8" width="200px" style={{ height: '240px'}}>
                <Row>
                  <Col span={24}>
                  <Row>
                  ...
                  <Row>
                    <Col span={24}>
                      <CardTitle>Laporan Informasi Yang<br></br>Sering Ditanyakan</CardTitle>
                    </Col>
                  </Row>
                  </Col>
                </Row>
            ...
            <Link to="/laporan/peforma-petugas" style={{ marginLeft: '50px' }}>
              <Card backgroundColor="#e8e8e8" width="200px" style={{ height: '240px'}}>
                <Row>
                  <Col span={24}>
                  <Row>
                  ...
                  <Row>
                    <Col span={24}>
                      <CardTitle>Laporan Kinerja Petugas<br></br>Duta Layanan</CardTitle>
                    </Col>
                  </Row>
                  </Col>
                </Row>
