...
const FrequentlyAsk = () => {
  ...
  const [dataChart] = useState({
    options: {
      ...
      xaxis: {
        categories: [ ['Visa 211A', '(VKSK)', '- Tujuan', 'Permohonan'], ['Paspor Biasa', '48 Halaman', '- Dokumen', 'Persyaratan'], ['Izin Tinggal', 'ITAS', '- Tahapan', 'Permohonan'], ['Visa', 'VITAS', '- Dokumen', 'Persyaratan'], ['Paspor', 'Elektronik 48', 'Halaman', '- Biaya', 'Permohonan'], ['Visa', '211A (VKSK)', '- Dokumen', 'Persyaratan'], ['Visa', '211A (VKSK)', '- Biaya', 'Permohonan'], ['Izin Tinggal', 'Kartu ITAP', '- Dokumen', 'Persyaratan']],
      },
    },
    series: [
      {
        ...
        <SubFeatureContent>
          ...
          <Col span={6}>
            <Card>
              ...
              <Title level={5} style={{ marginLeft: 0 }}>
                <strong>
                  <small>Laporan Informasi Layanan Keimigrasian yang Sering Ditanyakan</small>
                </strong>
              </Title>
              <br></br>
              <Form {...layout}>
          ...
          <Col span={14}>
            <Card style={{ marginLeft: '40px' }}>
              <h2><strong>Laporan Informasi Layanan Keimigrasian Yang Sering Ditanyakan</strong></h2>
              <h4>Semua Jenis Layanan di Kantor Imigrasi Kelas I Khusus Jakarta Selatan</h4>
