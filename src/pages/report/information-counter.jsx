...
import { Breadcrumb, Card, Form, Button, Select, DatePicker, Typography, Row, Col } from 'antd';
              ...
              <Form {...layout}>
                ...
                <Form.Item label="Jenis Produk"
                  ...
                  <Select
                    ...
                    onChange={handleChange}
                  >
                    <Option value="Paspor Biasa 48 Halaman">Paspor Biasa 48 Halaman</Option>
                    <Option value="Paspor Biasa 24 Halaman">Paspor Biasa 24 Halaman</Option>
                    <Option value="Paspor Elektronik 48 Halaman">Paspor Elektronik 48 Halaman</Option>
                    <Option value="Paspor Elektronik Polikarbonat">Paspor Elektronik Polikarbonat</Option>
                  </Select>
                </Form.Item>
                <Form.Item label="Informasi Produk"
                  name="informasi_produk"
                  rules={[{ required: true, message: 'Pilih informasi produk yang ditanyakan' }]}
                  style={{ flex: 1 }}>
                  <Select
