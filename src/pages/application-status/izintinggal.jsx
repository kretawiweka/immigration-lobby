              ...
              <Row>
                ...
                <Col span={7}>
                  ...
                  <Row>
                    ...
                    <Col span={15}>
                      <strong>Aisyah Aminati Bt Djafar Malek</strong>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={1}></Col>
                  ...
                  <Row>
                    ...
                    <Col span={15}>
                      <strong>Perlis, 03 Februari 1990</strong>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={1}></Col>
                  ...
                  <Row>
                    ...
                    <Col span={15}>
                      <strong>32918710000000381</strong>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={1}></Col>
                    ...
                    <Col span={15}>
                      <strong>Kantor Imigrasi Kelas I Ngurah Rai</strong>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={1}></Col>
                    ...
                    <Col span={15}>
                      <strong>28 November 2020 pukul 10:04:39</strong>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={1}></Col>
                    ...
                    <Col span={15}>
                      <strong>03 Desember 2020 pukul 09:13:40</strong>
                    </Col>
                  </Row>
                  <br></br>
                  <Row>
                  ...
                  <Row>
                    ...
                    <Col span={15}>
                      <strong>Perpanjangan ke-1 masa berlaku 2 Tahun</strong>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={1}></Col>
                    ...
                    <Col span={15}>
                      <strong>Pertukaran Mahasiswi (Pendidikan)</strong>
                    </Col>
                  </Row>
                </Col>
                <Col span={2}></Col>
                  ...
                  <Row>
                    ...
                    <Col span={22}>
                      <Steps direction="vertical" current={6} percent={50}>
                        <Step
                          title="1. Pengecekan Berkas dan Pencetakan Resi"
                          description="Selesai pada tanggal 28 November 2021 pukul 10:04:39"
                        />
                        <Step
                          title="2. Pemeriksaan Daftar Cekal"
                          description="Selesai pada tanggal 28 November 2021 pukul 10:23:01"
                        />
                        <Step
                          title="3. Pemindaian Berkas Dokumen"
                          description="Selesai pada tanggal 28 November 2021 pukul 10:25:58"
                        />
                        <Step
                          title="4. Pemeriksaan Penjamin"
                          description="Selesai pada tanggal 28 November 2021 pukul 15:04:39"
                        />
                        <Step
                          title="5. Pengambilan Data Biometrik"
                          description="Selesai pada tanggal 28 November 2021 pukul 08:03:21"
                        />
                        <Step
                          title="6. Transaksi Pembayaran"
                          description="Selesai pada tanggal 03 Desember 2021 pukul 13:14:47"
                        />
                        <Step
                          title="Persetujuan Izin Tinggal"
                          subTitle="(Sedang diproses)"
                        />
                        <Step
                          title="Penerbitan Nomor Register"
                          description=""
                        />
                        <Step
                          title="Pemindaian Dokumen Selesai"
                          description=""
                        />
