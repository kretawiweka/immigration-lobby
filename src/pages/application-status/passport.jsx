          ...
          <Card>
            <Form className="login-form" layout="horizontal">
              ...
              <Form.Item label="Kantor Imigrasi">
                <Input
                  placeholder="Kantor Imigrasi Kelas I Khusus Jakarta Selatan"
                  disabled
                />
              </Form.Item>
              <Button
            ...
            <Row>
              <Col span={18} push={6}>
                ...
                <Row>
                  ...
                  <Col span={14}>
                    <strong>
                      Kantor Imgirasi Kelas I Khusus Jakarta Selatan
                    </strong>
                  </Col>
                </Row>
                <Row>
                ...
                <Row>
                  ...
                  <Col span={14}>
                    <strong>17 November 2021</strong>
                  </Col>
                </Row>
                <br></br>
                <hr></hr>
